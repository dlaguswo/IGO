...
<script>	
    ...
    function acyncMovePage(url){
        ...
        $.ajax(ajaxOption).done(function(data){
            ...
            // Contents 영역 교체
            $('#bodyContents').html('<div class="dash-content bodyContents"><div class="container-fluid"><div class="row"><div class="col-md-12" style="padding-left: 30%;padding-right: 30%;"><div class="db-add-list-wrap"><div class="act-title"><h5><i class="ion-clock"> Administrator approval requested</i></h5>' +
 		'</div><div class="db-add-listing" ><div class="row" style="text-align: center;">' +
		'<div class="col-md-12" ><div class="form-group"><p style="font-size: 13pt;"><b>호스팅 신청완료</b></p></div><div><p style="font-size: 12pt;">관리자의 승인이 필요합니다.</p><p style="font-size: 12pt;">1 ~ 3일의 기간이 소요됩니다.</p>' +
		...
		'<p style="font-size: 13pt;"><b>Hosting Request Completed</b></p></div><div><p style="font-size: 12pt;">Administrator approval is required</p><p style="font-size: 12pt;">It takes 1-3 days.</p></div>' +
						...
						<!--  건물 정보입력 -->
							...
							<!--  건물 이름 입력 -->
											...
											<div class="form-group">
												...
												<input type="text" name="houseTilte" id="houseTitle" class="form-control filter-input" placeholder="House Title">
											</div>
										</div>
							...
							<!--  건물 주소 입력 -->
										<div class="col-md-6">
											<div class="form-group">
												<label>Address</label>
												<input type="text" name="address" class="form-control filter-input" placeholder="Address of your House">
											</div>
										</div>
							...
							<!--  호스트 연락처 , 유저테이블의 tel을 가져와서 기본값, 변경가능-->
										<div class="col-md-6">
											<div class="form-group">
												<label>Tel.</label>
												<input type="text" name="tel" class="form-control filter-input" placeholder="Reachable tel">
											</div>
										</div>
						...
						<!--  방 정보 및 가격  -->
							...
							<!--  방 이름 -->
											<div class="form-group">
												...
												<input type="text" name="roomName" class="form-control filter-input" placeholder="Standard family Room">
											</div>
										</div>
							...
							<!--  방 가격 -->
										<div class="col-md-6">
											<div class="form-group">
												<label>Price</label>
												<input type="text" name="price" class="form-control filter-input" placeholder="30000(￦)">
											</div>
										</div>
							...
							<!--  기준 인원 -->
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="people" class="form-control filter-input" placeholder="2 persons">
											</div>
										</div>
							...
							<!--  화장실 수, 침대 갯수, 침실 수 -->
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control filter-input" name="bathCount" placeholder="Bath Number">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label>Bed Number</label>
												<input type="text" class="form-control filter-input" name="bedCount" placeholder="Bed Number">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label>BedRoom Number</label>
												<input type="text" class="form-control filter-input" name="bedRoomCount" placeholder="BedRoom Number">
											</div>
										</div>
										<div class="col-md-12">
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="list_info" rows="4" name="textArea" placeholder="Enter your text here"></textarea>
												</div>
										</div>	
				...
				<!-- 서브 이미지 추가 -->
					...
					<!--  동의 버튼 -->
							<div class="col-md-6 text-right sm-left">
								...
								<input type="button" value="Accept" onclick="acyncMovePage('/tmi/room/addhostCheck')" class="btn v8">
