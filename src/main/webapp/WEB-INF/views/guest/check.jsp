...
<div id="d1">
 <img src="/tmi/resources/images/logo-black.png"/>
	<div>
	<font size="2">이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), 프로모션 안내 메일 수신(선택)에 모두 동의합니다.</font>
	<input type="checkbox" name="all" id="all"><hr/>
	</div>
 <div id="accordion">	
   <h3><a href="#"><font size="2">TMI 이용약관 동의(필수)</font><input type="checkbox" name="c1" id="c1"/></a></h3>
   <div>
     <textarea readonly="readonly" rows="5" cols="66" >
제 1 조 (목적)

이 약관은 TMI 주식회사 ("회사" 또는 "TMI")가 제공하는 TMI 및 TMI 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.


제 2 조 (정의)

이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 TMI 및 TMI 관련 제반 서비스를 의미합니다.
...
정보통신망법 규정에 따라 TMI에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.


1. 수집하는 개인정보

이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 TMI 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, TMI는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
...
위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 TMI 위치기반 서비스를 이용할 수 있습니다.


제 1 조 (목적)
이 약관은 TMI 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
